...
class IOControl():
    ...
    def get_all_cards(self):
        with open(self.lang_cards_all, mode="r", encoding=file_encoding) as data_file:
            return pd.read_csv(data_file)

    def get_cards(self):
        try:
            with open(self.lang_cards_learn, mode="r", encoding=file_encoding) as data_file:
    ...
    def write_cards(self, words_to_learn):
        ...
        with open(
                self.lang_cards_learn, mode="w", newline="", encoding=file_encoding) as write_file:
